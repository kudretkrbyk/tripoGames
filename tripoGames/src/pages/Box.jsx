  ...
  return (
    <div className="flex flex-col w-full item">
      <div className="relative py-10 ">
        <div className=" bg-center bg-cover w-full h-screen bg-[url(https://static.wixstatic.com/media/c837a6_eb60340e15f54022835c97b00104f933~mv2.jpg/v1/fill/w_1521,h_687,al_l,q_85,usm_0.66_1.00_0.01,enc_auto/c837a6_eb60340e15f54022835c97b00104f933~mv2.jpg)]   "></div>
        <div
          ref={divRef1}
        ...
        >
          <div className="flex items-center justify-start gap-2">
            {" "}
            <div className="bg-cover bg-center w-20 h-20 rounded-xl bg-[url(https://static.wixstatic.com/media/c837a6_315534a972aa4595923fab16bc937c57~mv2.jpg/v1/crop/x_440,y_610,w_1448,h_1446/fill/w_98,h_98,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/shutterstock_1015612369.jpg)]  "></div>{" "}
            <div>
              {" "}
              <div>Kipon</div>
      ...
      <div className="flex flex-col w-full p-10 gap-5">
        ...
        <div className="flex items-center justify-center gap-10 ">
          ...
          <div className="w-full group overflow-hidden rounded-3xl ">
            <div className="w-full h-96 rounded-3xl group-hover:scale-110 duration-1000 bg-center bg-cover bg-[url(https://static.wixstatic.com/media/c837a6_875f6e1b7ca6446380da792756735da3~mv2.jpg/v1/fill/w_1917,h_1080,q_90/c837a6_875f6e1b7ca6446380da792756735da3~mv2.webp)]   "></div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full h-screen relative flex items-center justify-center">
        ...
        <div className="absolute  flex flex-col items-center justify-center  w-1/2 gap-7  p-10 text-white">
          ...
          <div className="text-5xl text-center">
            Atıldığınız Maceralarda Token Kazanın ve En Nadir Eşyaları Açın
          </div>
