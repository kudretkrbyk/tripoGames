      ...
      <div className="relative py-10 ">
        <Parallax speed={-20}>
          ...
          <div className="w-full h-[800px]">
            {" "}
            <div className=" bg-center bg-cover w-full h-[600px] bg-[url(https://static.wixstatic.com/media/c837a6_eb60340e15f54022835c97b00104f933~mv2.jpg/v1/fill/w_1521,h_687,al_l,q_85,usm_0.66_1.00_0.01,enc_auto/c837a6_eb60340e15f54022835c97b00104f933~mv2.jpg)]   "></div>
          </div>
        </Parallax>
